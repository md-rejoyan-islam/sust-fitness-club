      ...
      ? [
          {
            ...
            category: "মাইলফলক",
            title: "এক বছর উদযাপন",
            description: "ফিটনেস ও শক্তির এক বছর পূর্তি",
          },
          {
            year: "২০২৫",
            category: "ইভেন্ট",
            title: "SUST হাফ ম্যারাথন",
            description: "২১.১ কিলোমিটার রানিং ইভেন্ট",
          },
          {
            year: "২০২৫",
            category: "বিশেষ",
            title: "ল্যাংগুয়েজ লিগ্যাসি রান",
            description: "মাতৃভাষা দিবসে ৭.৫K রান",
          },
          {
            year: "২০২৫",
            category: "কমিউনিটি",
            title: "সাপ্তাহিক সেশন",
            description: "প্রতি শুক্রবার সকাল ৫:৪৫",
          },
        ]
      : [
          {
            ...
            description: "Celebrating one year of fitness & strength",
          },
          {
            year: "2025",
            category: "Event",
            title: "SUST Half Marathon",
            description: "21.1 km running event",
          },
          {
            year: "2025",
            category: "Special",
            title: "Language Legacy Run",
            description: "7.5K run on Mother Language Day",
          },
          {
            year: "2025",
            category: "Community",
            title: "Weekly Sessions",
            description: "Every Friday at 5:45 AM",
          },
        ];
        ...
        <AnimatedSectionHeader>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {lang === "bn"
                ? "গর্বের সাথে অর্জিত সাফল্য"
                : "Proudly achieved success"}
            </p>
          </div>
        </AnimatedSectionHeader>
