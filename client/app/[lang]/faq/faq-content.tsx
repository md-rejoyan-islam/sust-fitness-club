                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#2ecc71]/20 to-[#27ae60]/10 dark:from-[#5ce1e6]/20 dark:to-[#4fd1d9]/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="relative p-6 rounded-2xl border-2 border-dashed border-gray-300 dark:border-slate-600 bg-white dark:bg-[#0d1117]/30">
              ...
              <div className="rounded-xl overflow-hidden bg-white dark:bg-[#161b22] p-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#2ecc71] to-[#27ae60] dark:from-[#5ce1e6] dark:to-[#4fd1d9] flex items-center justify-center shadow-lg shadow-[#2ecc71]/30 dark:shadow-[#5ce1e6]/30">
                      <MessageCircle className="w-7 h-7 text-white dark:text-[#0d1117]" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">
                        {lang === 'bn' ? 'আমাদের সাথে কথা বলুন' : 'Talk to Us'}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        {lang === 'bn' ? 'যেকোনো প্রশ্নের জন্য যোগাযোগ করুন' : 'Reach out for any questions'}
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-8 grid sm:grid-cols-2 gap-4">
            <a
              ...
              className="p-6 rounded-2xl bg-gradient-to-r from-white to-gray-50 dark:from-[#1a2332] dark:to-[#0d1117] border border-gray-200 dark:border-[#2d3f50] hover:border-[#2ecc71] dark:hover:border-[#5ce1e6] transition-colors group"
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {lang === 'bn' ? 'আমাদের ফেসবুক পেজে মেসেজ করুন' : 'Message us on our Facebook page'}
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {lang === 'bn' ? 'ক্লাব সম্পর্কে আরও জানুন' : 'Learn more about our club'}
                  </p>
                </div>
              </div>
            </Link>
